...
public class Auto {
	...
	public void dañar() {
		if (invencible <= 0) { // Si el auto no es invencible, si éste se daña pierde una vida y detiene a los
								// objetos por unos momentos
			vidas--;
			herido = true;
	...
	public void actualizarMovimiento() {
		...
		if (Gdx.input.isKeyPressed(Input.Keys.LEFT))
			car.x -= velx * Gdx.graphics.getDeltaTime();
